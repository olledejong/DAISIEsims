...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type init_nonend_spec(init_nonend_specSEXP);
    Rcpp::traits::input_parameter< int >::type init_end_spec(init_end_specSEXP);
    Rcpp::traits::input_parameter< std::vector<int> >::type mainland_spec(mainland_specSEXP);
    Rcpp::traits::input_parameter< std::vector<int> >::type init_nonend_spec_vec(init_nonend_spec_vecSEXP);
    Rcpp::traits::input_parameter< std::vector<int> >::type init_end_spec_vec(init_end_spec_vecSEXP);
    Rcpp::traits::input_parameter< int >::type maxspecID(maxspecIDSEXP);
    rcpp_result_gen = Rcpp::wrap(DAISIE_spec_tables_cpp(total_time, timeval, init_nonend_spec, init_end_spec, mainland_spec, init_nonend_spec_vec, init_end_spec_vec, maxspecID));
    return rcpp_result_gen;
END_RCPP
}
